...
\begin{document}
    ...
    \begin{tabularx}{\textwidth}{?{2pt}Y|Y?{2pt}}
        ...
        \hline
        \hlinewd{2pt}
        $\frac{\Gamma, A(t \diagup x) \separ \Delta}{\Gamma, \forall x A \separ \Delta}$ & $\frac{\Gamma \separ A(y \diagup
            x), \Delta}{\Gamma \separ \forall x A, \Delta}$\\ [20pt]
        \hline
        $\frac{\Gamma, A(y \diagup x) \separ \Delta}{\Gamma, \exists x A \separ \Delta}$ & $\frac{\Gamma \separ A(t \diagup
            x), \Delta}{\Gamma \separ \exists x A, \Delta}$\\ [20pt]
        \hlinewd{2pt}
	\end{tabularx}
